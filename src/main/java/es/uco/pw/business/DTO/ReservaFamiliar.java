...
/**
* Clase que hereda de reserva y representa las reservas realizadas para pistas de carácter familiar
...
public class ReservaFamiliar extends ReservaDTO {
	...
	public ReservaFamiliar(int id_reserva,String id_usuario, Date fecha_hora, int minutos, String id_pista, float precio_reserva,
			int descuento, Tipo_Reserva reserva, int num_adultos, int num_children,Tipo_Bono bono) {
		super(id_reserva,id_usuario, fecha_hora, minutos, id_pista, precio_reserva, descuento, reserva,num_adultos,num_children,bono);
